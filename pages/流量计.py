...
def check_table_header(frame_locator):
    ...
    try:
        ...
        expect(frame_locator.get_by_text("流量计名称")).to_be_visible()
        ...
        expect(frame_locator.get_by_text("设备健康度")).to_be_visible()
        ...
        expect(frame_locator.get_by_label("设备厂商")).to_be_visible()
        expect(frame_locator.get_by_label("设备类型")).to_be_visible()
...
def export_report(iframe_locator,page):
    ...
    try:
        ...
        iframe_locator.get_by_role("button", name="确 定").click()
        iframe_locator.get_by_label("入口线圈电压").uncheck()
        iframe_locator.get_by_label("出口线圈电压").uncheck()
        iframe_locator.get_by_label("密度").uncheck()
        iframe_locator.get_by_label("驱动增益").uncheck()
        with page.expect_download() as download_info:
...
def device_details_page(frame_locator):
    ...
    try:
        ...
        frame_locator.get_by_label("两相故障指标").uncheck()
        frame_locator.get_by_label("零漂故障指标").uncheck()
